class Node:
    ...
    def calc_dir_size(self):
        ...
        self.size = sum
        self.unused = self.total_size - self.size
        self.min = self.req - self.unused
        return sum
